...
def index(request):
    ...
    context = {}
    # return render(request, "voting1/login.html", context)
...
def dashboard(request):
    ...
    if user.voter.otp is None or user.voter.verified == False:
        ...
        if user.voter.voted:  # * User has voted
            ...
            return render(request, "voting1/voter/result.html", context)
        else:
            return redirect(reverse('show_ballot'))
...
def verify(request):
    ...
    return render(request, "voting1/voter/verify.html", context)
...
def show_ballot(request):
    ...
    return render(request, "voting1/voter/ballot.html", context)
